            ...
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <a href="/" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                        <Image src={logoImg} height="50" alt="Notter Logo" className="drop-shadow-xl"/>
                    </a>
                ...
                <span className="block text-sm text-gray-400 sm:text-center ">© 2021-2026 <a href="https://qual.su" className="hover:underline">Qualsu</a></span>
            </div>
        </footer>
    )
}